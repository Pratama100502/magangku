                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="{{ route('mentor.create') }}" class="btn btn-custom mr-3" title="Tambah Mentor">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if(request('nama'))
                                        <div class="input-group-append">
                                            <a href="{{ route('mentor.index') }}" class="btn btn-outline-danger" title="Reset pencarian">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('mentor.edit', $mentor->id) }}" class="btn btn-sm btn-warning" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>                                                
                                                <form action="{{ route('mentor.destroy', $mentor->id) }}" method="POST" class="d-inline delete-form">
                                                    @csrf
                                                    @method('DELETE')
