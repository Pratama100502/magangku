                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('asal_sekolah') is-invalid @enderror"
                                                    id="asal_sekolah" name="asal_sekolah" placeholder="Masukkan asal sekolah/universitas"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                                    ...
                                                    <option value="mengajukan" {{ old('status', $peserta->status) == 'mengajukan' ? 'selected' : '' }}>Mengajukan</option>
                                                    <option value="diterima" {{ old('status', $peserta->status) == 'diterima' ? 'selected' : '' }}>Diterima</option>
                                                    <option value="diterima_dan_loa_dapat_di_ambil" {{ old('status', $peserta->status) == 'diterima_dan_loa_dapat_di_ambil' ? 'selected' : '' }}>Diterima dan LOA dapat diambil</option>
                                                    ...
                                                    <option value="ditolak" {{ old('status', $peserta->status) == 'ditolak' ? 'selected' : '' }}>Ditolak</option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('mentor_id') is-invalid @enderror" id="mentor_id" name="mentor_id">
                                                    <option value="">Pilih Mentor (Opsional)</option>
                                                    @foreach($mentors as $mentor)
                                                        <option value="{{ $mentor->id }}" {{ old('mentor_id', $peserta->mentor_id) == $mentor->id ? 'selected' : '' }}>{{ $mentor->nama }}</option>
                                                    @endforeach
                                                </select>
                                                @error('mentor_id')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('catatan') is-invalid @enderror" id="catatan" name="catatan" placeholder="Masukkan catatan (opsional)">{{ old('catatan', $peserta->catatan) }}</textarea>
                                                @error('catatan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror"
                                                    id="tanggal_mulai" name="tanggal_mulai" value="{{ old('tanggal_mulai', $peserta->tanggal_mulai) }}" required>
                                                @error('tanggal_mulai')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror"
                                                    id="tanggal_selesai" name="tanggal_selesai" value="{{ old('tanggal_selesai', $peserta->tanggal_selesai) }}" required>
                                        ...
                                        @foreach($peserta->anggota as $index => $anggota)
                                            <div class="anggota-item row mb-3">
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" class="form-control" name="anggota[{{ $index }}][nama]" 
                                                        placeholder="Nama Anggota" value="{{ old('anggota.'.$index.'.nama', $anggota->nama) }}">
                                                </div>
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" name="anggota[{{ $index }}][no_hp]" 
                                                        placeholder="Nomor HP Anggota" value="{{ old('anggota.'.$index.'.no_hp', $anggota->no_hp) }}">
                                                </div>
                                                <div class="col-md-2">
