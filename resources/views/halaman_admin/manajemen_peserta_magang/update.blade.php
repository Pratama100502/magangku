                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('tanggal_mulai', $peserta->tanggal_mulai) }}" required>
                                            @error('tanggal_mulai')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('tanggal_selesai', $peserta->tanggal_selesai) }}" required>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function createAnggotaField() {
                ...
                div.innerHTML = `
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="anggota[${anggotaCount}][no_hp_anggota]" placeholder="Nomor HP Anggota">
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-sm btn-danger hapus-anggota">
                            <i class="fas fa-trash"></i> Hapus
