                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                ...
                                                <option value="mengajukan" {{ request('status') == 'mengajukan' ? 'selected' : '' }}>Mengajukan</option>
                                                <option value="diterima" {{ request('status') == 'diterima' ? 'selected' : '' }}>Diterima</option>
                                                <option value="diterima_dan_loa_dapat_di_ambil" {{ request('status') == 'diterima_dan_loa_dapat_di_ambil' ? 'selected' : '' }}>Diterima dan LOA dapat di ambil</option>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="col-md-6">
                                <a href="{{ route('peserta.create') }}" class="btn btn-custom mr-3" title="Tambah Peserta Magang">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('peserta.show', $peserta->id) }}" class="btn btn-info btn-sm" title="Show">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('peserta.edit', $peserta->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('peserta.destroy', $peserta->id) }}" method="POST" class="d-inline delete-form">
                                                    @csrf
                                                    @method('DELETE')
